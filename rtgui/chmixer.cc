...
ChMixer::ChMixer (): FoldableToolPanel(this, "chmixer", M("TP_CHMIXER_LABEL"), false, true)
{
    ...
    red[0] = Gtk::manage (new Adjuster ("",   -500, 500, 0.1, 100, imgIcon[0]));
    red[1] = Gtk::manage (new Adjuster ("", -500, 500, 0.1, 0, imgIcon[1]));
    red[2] = Gtk::manage (new Adjuster ("",  -500, 500, 0.1, 0, imgIcon[2]));
    ...
    green[0] = Gtk::manage (new Adjuster ("",   -500, 500, 0.1, 0, imgIcon[3]));
    green[1] = Gtk::manage (new Adjuster ("", -500, 500, 0.1, 100, imgIcon[4]));
    green[2] = Gtk::manage (new Adjuster ("",  -500, 500, 0.1, 0, imgIcon[5]));
    ...
    blue[0] = Gtk::manage (new Adjuster ("",   -500, 500, 0.1, 0, imgIcon[6]));
    blue[1] = Gtk::manage (new Adjuster ("", -500, 500, 0.1, 0, imgIcon[7]));
    blue[2] = Gtk::manage (new Adjuster ("",  -500, 500, 0.1, 100, imgIcon[8]));
