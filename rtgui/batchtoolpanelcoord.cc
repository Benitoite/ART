    ...
    */
    ...
    if (!selected.empty()) {
        ...
        if (selected.size() == 1) {
            ...
            drcomp->setAdjusterBehavior (false, false, false);
            ...
            drcomp->setAdjusterBehavior (options.baBehav[ADDSET_FATTAL_AMOUNT], options.baBehav[ADDSET_FATTAL_THRESHOLD], options.baBehav[ADDSET_FATTAL_ANCHOR]);
